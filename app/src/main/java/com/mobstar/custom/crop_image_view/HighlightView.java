...
public class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(eu.janmuller.android.simplecropimage.R.drawable.camera_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(eu.janmuller.android.simplecropimage.R.drawable.camera_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(eu.janmuller.android.simplecropimage.R.drawable.indicator_autocrop);
    }
