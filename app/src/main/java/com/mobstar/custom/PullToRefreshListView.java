...
public class PullToRefreshListView extends ListView {
	...
	private static final float PULL_RESISTANCE = 2f;
	...
	private void init() {
		...
		getContext().getString(R.string.ptr_pull_to_refresh);
		getContext().getString(R.string.ptr_release_to_refresh);
		getContext().getString(R.string.ptr_refreshing);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			//Log.v(Constant.TAG, "previousY "+previousY);
	...
	private void bounceBackHeader() {
		...
		TranslateAnimation bounceAnimation = new TranslateAnimation(TranslateAnimation.ABSOLUTE, 0, TranslateAnimation.ABSOLUTE, 0, TranslateAnimation.ABSOLUTE, 0,
